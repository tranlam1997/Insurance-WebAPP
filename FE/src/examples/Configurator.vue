      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div
            ...
            :class="this.$store.state.admin.isRTL ? 'text-end' : ' text-start'"
          >
            <span
        ...
        <div class="form-check form-switch ps-0">
          <input
            ...
            :class="this.$store.state.admin.isRTL ? 'float-end  me-auto' : ' ms-auto'"
            type="checkbox"
            id="navbarFixed"
            :checked="this.$store.state.admin.isNavFixed"
...
export default {
  ...
  methods: {
    ...
    sidebarColor(color = "success") {
      ...
      this.$store.state.admin.mcolor = `card-background-mask-${color}`;
    },
    ...
    setNavbarFixed() {
      if (this.$route.name !== "Profile") {
        this.$store.state.admin.isNavFixed = !this.$store.state.admin.isNavFixed;
      }
    },
